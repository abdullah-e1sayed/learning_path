...
if(isset($_POST['submit'])){
  if(isset($_POST['message']) or  isset($_POST['subject'] ) or isset($_POST['email'])  or isset($_POST['name'])){
    $message = $_POST['message'];
    $subject = $_POST['subject'];
    $email = $_POST['email'];
    $name = $_POST['name'];

    $send =$conn->prepare("INSERT INTO users_messages(username,email,subject,message) 
...
?>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/thumbnail/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <?php if (isset($_POST['message'])){ echo "Your message was sent, thank you!";}?>

          
            <form action="contact.php" method="POST" class="p-5 bg-white border">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Full Name</label>
                  <input type="text" name ="name" value="<?php (isset($_SESSION['username']))?  print $_SESSION['username']: print ''; ?>" id="fullname" class="form-control" placeholder="Full Name">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="email">Email</label>
                  <input type="email" name ="email" value="<?php (isset($_SESSION['username']))?  print $_SESSION['email']: print ''; ?>" id="email" class="form-control" placeholder="Email Address">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4"> SHARKIA, EGYPT</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="https://wa.me/+201060431414">+20 10 6043 1414</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="">abdullahelsayed009@gmail.con</a></p>
