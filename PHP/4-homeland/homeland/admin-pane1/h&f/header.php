<?php  
if ($nav_item != "login-admins.php" AND !isset($_SESSION['adminName'])){
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <?php  if($nav_item !="login-admins.php"): ?>
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL?>messages-admins/show-messages.php" style="margin-left: 20px;">Messages</a>
          </li>
        </ul>
