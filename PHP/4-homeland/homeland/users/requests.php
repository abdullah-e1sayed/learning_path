...
$select_props = $conn->prepare("SELECT * FROM props JOIN contact ON props.id = contact.home_id where contact.user_id={$_SESSION['id']} ;");
...
<div class ="site-wrap">
        ...
        <div class="row mb-5">
           ...
           if($select_props->rowCount()==0){
            ...
            echo "<h1 class='col-md-10'>you don't have any requests yet .</h1>";
