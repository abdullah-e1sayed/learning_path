		...
		<?php
			...
			if(isset( $_POST['submit'])){
				if(empty($_POST['username'])OR empty($_POST['pass'] )OR empty($_POST['email']) ){
					...
					echo "<script>window.location.href='".APPURL."auth/login.php'</script> ";   //header("location: login.php");
				}
