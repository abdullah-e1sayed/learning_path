			...
			<?php foreach($allHotels as $hotel ):
				...
				?>
					<div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
						...
						<div class="img" style="background-image: url(<?php echo IMAGEHOTELS ?>/<?php echo $hotel->image; ?>);"></div>
		 	...
		 	foreach($allRooms as $room):
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="rooms/room-single.php?id=<?php echo $room->id;?>" class="img" style="background-image: url(<?php echo IMAGEROOMS ?>/<?php echo $room->image;?>);"></a>
