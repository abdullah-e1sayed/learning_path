			...
			<div class="container">
              ...
              <li><a href="#" class="py-1 d-block">Perfect central location</a></li>
					...
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						...
						<div class="tagcloud">
	            <a href="<?PHP echo APPURL;?>rooms/rooms.php?id=1" class="tag-cloud-link">apartment</a>
	            <a href="<?PHP echo APPURL;?>" class="tag-cloud-link">home</a>
	            <a href="#" class="tag-cloud-link">vacation</a>
	            <a href="#" class="tag-cloud-link">rental</a>
	            <a href="#" class="tag-cloud-link">rent</a>
	            <a href="<?PHP echo APPURL;?>" class="tag-cloud-link">house</a>
